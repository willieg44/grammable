...
RSpec.describe GramsController, type: :controller do
    describe "grams#destroy action" do
        it "should't allow users who didn't create the gram to destroyh it" do
        ...
        it "shouldn't let aunthenticated users destroy a gram" do
            gram = FactoryBot.create(:gram)
            delete :destroy, params: { id: gram.id }
    ...
    describe "grams#update action" do
        ...
        it "should'nt let unauthenticated users update a gram" do
            gram = FactoryBot.create(:gram)
        ...
        it "should have http 404 error if the gram cannot be found" do
            ...
            patch :update, params: { id: "YOLOSWAG", gram: { message: 'Changed0' } }
            expect(response).to have_http_status(:not_found)
